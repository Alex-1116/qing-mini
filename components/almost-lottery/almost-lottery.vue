    ...
    props: {
      ...
      imageHeight: {
        ...
        default: 30
			...
			successMsg: {
				type: String,
				default: '食物准备就绪，赶快来参与吧~'
			},
			// 转盘绘制失败的提示
			failMsg: {
				type: String,
				default: '食物仍在准备中，请稍后再来...'
			},
			// 是否开启画板的缓存
			canvasCached: {
				type: Boolean,
...
<style lang="scss" scoped>
  ...
  .almost-lottery__action {
    ...
    background-position: center center;
    background-size: contain;
    // background-image: url("https://qn.oneidea.xyz/15641614918940_.pic_hd.jpg");
	background-image: url($actionBgUrl + ".png");

    @media (-webkit-min-device-pixel-ratio: 2), (min-device-pixel-ratio: 2) {
      // background-image: url("https://qn.oneidea.xyz/15631614918939_.pic_hd.jpg");
	  background-image: url($actionBgUrl + "2x.png");
    }

    // @media (-webkit-min-device-pixel-ratio: 3), (min-device-pixel-ratio: 3) {
    //   background-image: url("https://qn.oneidea.xyz/15621614918939_.pic_hd.jpg");
